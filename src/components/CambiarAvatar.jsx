                    ...
                    <div className="contenedor-modal">
                        ...
                        <div className="contenedor-avatars">
                            {avatarHombres.map(avatar => (
                                <img key={avatar.id} onClick={()=>avatarSeleccionado(avatar.avatar)} className={ seleccionado==avatar.avatar ? "seleccionado": "avatar-a-cambiar"} src={avatar.avatar} alt="avatar" />
                            ))}
                        </div>
